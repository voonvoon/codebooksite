...
export default function Shop() {
    ...
    const [radio, setRadio] = useState([]); //radio , array cuz the price in array format
    ...
    const handleCheck = (value, id) => {
        ...
        if (value) {    // if true
            ...
            all = all.filter((c) => c !== id);  // if each cat !== incoming id then filter out the rest of the cat
        }
    ...
    return (
        <>
            <Jumbotron title="Hello World" subTitle="Welcome To Skyfree Book Store" />


            <div className="container-fluid">
                <div className="row">
                    <div className="col-md-3">
                    <h2 className="p-3 mt-2 mb-2 h4 bg-light text-center">{products?.length}
