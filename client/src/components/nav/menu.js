import { NavLink } from "react-router-dom"; // mk link work must use this in react! it show active link also!
...
export default function Menu() {
    ...
    // hooks
    const categories = useCategory();  // own created hook
    const navigate = useNavigate(); 

   // console.log("categories in menu =>", categories);

    const logout = () => {
        setAuth({ ...auth, user: null, token: ""}); // set tis to ensure it react now instead of rely on localstorage.
